...
function Necrosis:SpellLocalize(tooltip) 
	...
	if not tooltip then
		self.Spell = {
			...
			[17] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 20,	Type = 3}, -- NOPE NOT IN Shadowfury || Furie de l'ombre
			...
			[20] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 15,	Type = 3}, -- Shadowburn || Brûlure de l'ombre
			[21] = {Name = GetSpellInfo(17962),	Mana = 50,				Length = 10,	Type = 3}, -- Conflagration
			[22] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 24,	Type = 4}, -- Curse of Agony || Malédiction Agonie
			[23] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 120,	Type = 4}, -- Curse of Weakness || Malédiction Faiblesse
			[24] = {Name = GetSpellInfo(5784),	Mana = 0 ,              Length = 0,	    Type = 0}, -- Curse of Recklessness - removed in patch 3.1 || Malédiction Témérité || 
			[25] = {Name = GetSpellInfo(11719),	Mana = 50,				Length = 30,	Type = 4}, -- Curse of Tongues || Malédiction Langage
			[26] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 300,	Type = 4}, -- Curse of the Elements || Malédiction Eléments
			[27] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 180,	Type = 3}, -- Metamorphosis || Metamorphose
			[28] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 30,	Type = 6}, -- Siphon Life || Syphon de vie
			...
			[31] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 0,		Type = 0}, -- Demon Armor || Armure démoniaque
			...
			[39] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 45,		Type = 3}, -- Demon Charge || Charge démoniaque
			[40] = {Name = GetSpellInfo(18223),	Mana = 50,				Length = 12,	Type = 4}, -- Curse of Exhaustion || Malédiction de fatigue
			[41] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 40,	Type = 2}, -- Life Tap || Connexion
			[42] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 12,	Type = 2}, -- Haunt || Hanter
			[43] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 30,	Type = 3}, -- Shadow Ward || Gardien de l'ombre
			[44] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 60,	Type = 3}, -- Sacrifice || Sacrifice démoniaque 
			[45] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 0,		Type = 0}, -- Shadow Bolt
			[46] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 18,	Type = 6}, -- Unstable Affliction || Affliction instable
			[47] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 0,		Type = 0}, -- Fel Armor || Gangrarmure
			[48] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 18,	Type = 5}, -- Seed of Corruption || Graine de Corruption
			[49] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 180,	Type = 3}, -- SoulShatter || Brise âme
			[50] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 300,	Type = 3}, -- Ritual of Souls || Rituel des âmes
			...
			[53] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 0,		Type = 0}, -- Create Spellstone || Création pierre de sort
			[54] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 0,		Type = 0}, -- Create Firestone || Création pierre de feu
			[55] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 0,		Type = 0}, -- Dark Pact || Pacte noir
			[56] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 0,		Type = 0}, -- Shadow Cleave || Enchainement d'ombre
			[57] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 30,	Type = 3}, -- Immolation Aura || Aura d'immolation
			[58] = {Name = GetSpellInfo(5784),	Mana = 50,				Length = 15,	Type = 3}, -- Challenging Howl || Hurlement de défi
			[59] = {Name = GetSpellInfo(5784),	Mana = 50,			    Length = 60,	Type = 3} -- Demonic Empowerment || Renforcement démoniaque
		}
